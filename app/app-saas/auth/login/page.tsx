      ...
      <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Ou{' '}
            <Link href="/app-saas/auth/register" className="font-medium text-trust hover:text-trust-dark">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link href="/app-saas/auth/reset-password" className="font-medium text-trust hover:text-trust-dark">
                    Mot de passe oublié ?
                  </Link>
                </div>
              </div>
              ...
              <div>
                <button
                  type="submit"
                  className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-trust hover:bg-trust-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-trust"
                >
                  Se connecter
                </button>
              </div>
