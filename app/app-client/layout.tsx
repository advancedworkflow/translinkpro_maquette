...
export default function ClientLayout({
  ...
  const navigation = [
    { name: 'Tableau de bord', href: '/app-client', icon: BarChart3 },
    { 
      name: 'Transport', 
      icon: Truck, 
      children: [
        { name: 'Nouvelle demande', href: '/app-client/nouvelle-demande', icon: Plus },
        { name: 'Suivi en temps réel', href: '/app-client/suivi', icon: MapPin },
        { name: 'Comparaison offres', href: '/app-client/offres', icon: Package },
      ]
    },
    { 
      name: 'Historique', 
      icon: History, 
      children: [
        { name: 'Mes courses', href: '/app-client/courses', icon: Truck },
        { name: 'Factures', href: '/app-client/factures', icon: FileText },
      ]
    },
    { name: 'Profil', href: '/app-client/profil', icon: User },
    { name: 'Paramètres', href: '/app-client/parametres', icon: Settings },
  ]
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-white truncate">
                {user.profile.nomComplet}
              </p>
              <p className="text-xs text-gray-400 truncate">
                {user.profile.raisonSociale || 'Client'}
              </p>
            </div>
          </div>
          <button 
